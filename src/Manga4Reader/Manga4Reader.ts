...
const SOURCE_DOMAIN = "https://www.manga4reader.com/"

export class Manga4Reader extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Manga4Reader' }
    get description(): string { return 'Manga For Reader' }
    get author(): string { return 'SawcyD' }
